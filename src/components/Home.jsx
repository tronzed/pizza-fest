                  ...
                  <div className="row g-4">
                    <div className="col-lg-12">
                      <div className="row g-4">
                        {data?.map((item, index) => (
                          <>
                            <ProductItem imgUrl={item?.img_url} name={item.name} text={item.text} price={item.price} idBox={item?.firebaseID} addCart={() => addCart(item?.firebaseID)} setLoader={setLoader} />
                          </>
                        ))}
                      </div>
                    </div>
