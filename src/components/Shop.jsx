                            ...
                            <div className="row g-4">
                                ...
                                <div className="col-lg-12">
                                    <div className="row g-4 justify-content-center">
                                        ...
                                        {data?.map((item, index) => (
                                            <>
                                                <ProductItem imgUrl={item?.img_url} key={index} name={item.name} idBox={item?.firebaseID} text={item.text} price={item.price} addCart={() => addCart(item?.firebaseID)} setLoader={setLoader} />
                                            </>
                                        ))}
